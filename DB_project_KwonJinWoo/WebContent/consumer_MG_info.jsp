...
<head>
<meta charset="EUC-KR">
<title>consumer_MG</title>
</head>
<body><% // 소비자에서 정보확인 중 소유 마법 상세정보 보기 창
String url= request.getHeader("referer");
	...
	try {
		...
		String magic_name = (String)(request.getParameter("magic_name"));
		...
		<p>마법 상세 정보</p>
		<p>마법ID :<%=magic_ID %> </p>
		<p>마법 이름 :<%=magic_name %> </p>
		<p>클래스 :<%=classs %> </p>
		<p>속성 :<%=property %> </p>
		<p>판매가격 :<%=sale_price %> </p><br>
		<%
	if(redirect != null)
	{
